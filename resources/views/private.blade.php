            ...
            <div id="c_1" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="{{$user->user_name}}">
                <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                    <div class="d-flex flex-row align-items-center">
                                ...
                                @if($user->online_status == 'Онлайн')
                                    <span class="status status-success mr-3">
                                @elseif($user->online_status == 'Отошел')
                                ...
                                @endif
                                    ...
                                    @else
                                        <span class="rounded-circle profile-image d-block " style="background-image:url('/uploads/avatar.png'); background-size: cover;"></span>
                                    @endif
                                </span>
                        <div class="info-card-text flex-1">

                            @if($user->user_name)
                                <a href="/user/{{$user->id}}" class="fs-xl text-truncate text-truncate-lg text-info">{{$user->user_name}}</a>
                            @else
                                <a href="/user/{{$user->id}}" class="fs-xl text-truncate text-truncate-lg text-info">No name</a>
                            @endif
...
<footer class="page-footer" role="contentinfo">
    <div class="d-flex align-items-center flex-1 text-muted">
        <span class="hidden-md-down fw-700">{{$year}} © Учебный проект</span>
    </div>
    <div>
